...
const handleErrorLogging = (error, analyticsData) => {
  ...
  if (error.code === 'EVALIDATION') {
    analytics.logEvent('Validation error', evt)
  } else if (error.code === 'EUNPLUGGED') {
    analytics.logEvent('Drive unplugged', evt)
  } else if (error.code === 'EIO') {
    analytics.logEvent('Input/output error', evt)
  } else if (error.code === 'ENOSPC') {
    analytics.logEvent('Out of space', evt)
  } else if (error.code === 'ECHILDDIED') {
    analytics.logEvent('Child died unexpectedly', evt)
  } else {
